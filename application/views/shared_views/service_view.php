    ...
    <section class="wrapper">
        ...
        <div class="col-sm-10">
                                <div class="input-group  m-bot15">
                                    ...
                                    <label> <button class="form-control" type="button">Buscar</button></label>
                                    <input type="text" class="form-control" id="search" autofocus="" value="<?php echo ($_GET['val'])?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group  m-bot15">
                                    ...
                                    <label> <button class="btn btn-success buscar" type="button">Buscar</button></label>
