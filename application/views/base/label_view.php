...
<section id="main-content">
    <section class="wrapper">
        ...
        <section class="panel">
            <header class="panel-heading">
                 <center> Validaor de Código </center></b>
            </header>
    ...
    <div class="art-postcontent"><br>
        ...
        <p>
        Se utiliza el elemento <code>&lt;label&gt;</code> y en algunos casos otros mecanismos como WAI-ARIA, el atributo title,etc; para identificar cad uno de los controles del formulario </p>
        <p>
        En las paginas web se proporcionan etiquetas para identificar todos los controles de formulario, los cuales incluyen campos de texto, campos de verificación, botones de opción y menus desplegables; para los cuales en la mayoria de los casos se usa el atributo <code>&lt;label&gt;</code></p>
        <p>Un etiqueta label y un control de formulario deben estar asociados entre si de forma implicita o explicita. Lo cual permite que las tecnologias asistivas identifiquen el label correcto cuando se presenta un control de formulario.</p>


        <h5>Asociación de Labels de Forma Explicita</h5>

        <p>Siempre que sea posible, use el elemento label para asociar explicitamente textos con elementos del formulario. El atributo for de la etiqueta debe coincidir exacatamente con el id del control de formulario.</p>
...
<p>
    Un label ayuda a comprender mejor el proposito de un control de formulario; sin embargo en algunos casos el proposito de los controles de formulario es claro a plena vista por lo cual se puede ocultar el label, teniedo claro que aun asi dentro del codigo debe proporcionarse para soportar otros tipos de interacción, como lectores de pantalla y entradas de voz.  
...
<h5>Asociación de Labels de Forma Implicita</h5>
<p>En Algunas ocasiones, los controles de formulario no pueden etiquetarse eplicitamente, dado que es posible que un desarrollador no conozca el ID de un campo del formulario generado por un script o que el script no genere un ID. En estos casos se usa usa el elemento label como un contenedor para el control de formulario y el texto del label, de tal forma que los dos se asocian implicitamente</p>
...
<p>Etiquetas Button</p>
<p>La etiqueta &lt;button&gt; puede ser utilizada de igual forma que la etiqueta &lt;input&gt;, sin embargo la etiqueta button permite más caracteristicas de accesibilidad, como por ejemplo al traducir el idioma de la pagina</p>
